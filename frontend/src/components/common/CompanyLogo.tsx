 ...
 * All lookups are case-insensitive to handle Teller's ALL CAPS names.
 */
...
/* ---- Lookup table (all lowercase keys for case-insensitive matching) ---- */
...
const LOOKUP_RAW: Record<string, CompanyInfo> = {
  ...
  // Consumer brands & tickers
  'coca-cola': { domain: 'coca-cola.com', website: 'https://www.coca-cola.com' },
  'ko': { domain: 'coca-cola.com', website: 'https://www.coca-cola.com' },
  'pepsi': { domain: 'pepsico.com', website: 'https://www.pepsico.com' },
  'pepsico': { domain: 'pepsico.com', website: 'https://www.pepsico.com' },
  'pep': { domain: 'pepsico.com', website: 'https://www.pepsico.com' },
  "lay's": { domain: 'pepsico.com', website: 'https://www.pepsico.com' },
  'procter & gamble': { domain: 'pg.com', website: 'https://www.pg.com' },
  'pg': { domain: 'pg.com', website: 'https://www.pg.com' },
  'tide': { domain: 'pg.com', website: 'https://www.pg.com' },
  'bounty': { domain: 'pg.com', website: 'https://www.pg.com' },
  'unilever': { domain: 'unilever.com', website: 'https://www.unilever.com' },
  'ul': { domain: 'unilever.com', website: 'https://www.unilever.com' },
  "ben & jerry's": { domain: 'benjerry.com', website: 'https://www.benjerry.com' },
  'colgate': { domain: 'colgatepalmolive.com', website: 'https://www.colgatepalmolive.com' },
  'colgate-palmolive': { domain: 'colgatepalmolive.com', website: 'https://www.colgatepalmolive.com' },
  'cl': { domain: 'colgatepalmolive.com', website: 'https://www.colgatepalmolive.com' },
  // Airlines & travel
  'delta airlines': { domain: 'delta.com', website: 'https://www.delta.com' },
  'dal': { domain: 'delta.com', website: 'https://www.delta.com' },
  'american airlines': { domain: 'aa.com', website: 'https://www.aa.com' },
  'aal': { domain: 'aa.com', website: 'https://www.aa.com' },
  'united airlines': { domain: 'united.com', website: 'https://www.united.com' },
  'ual': { domain: 'united.com', website: 'https://www.united.com' },
  'hilton': { domain: 'hilton.com', website: 'https://www.hilton.com' },
  'hlt': { domain: 'hilton.com', website: 'https://www.hilton.com' },
  'marriott': { domain: 'marriott.com', website: 'https://www.marriott.com' },
  'mar': { domain: 'marriott.com', website: 'https://www.marriott.com' },
  // SaaS & business
  'salesforce': { domain: 'salesforce.com', website: 'https://www.salesforce.com' },
  'crm': { domain: 'salesforce.com', website: 'https://www.salesforce.com' },
  'adobe': { domain: 'adobe.com', website: 'https://www.adobe.com' },
  'adbe': { domain: 'adobe.com', website: 'https://www.adobe.com' },
  'zoom': { domain: 'zoom.us', website: 'https://www.zoom.us' },
  'zm': { domain: 'zoom.us', website: 'https://www.zoom.us' },
  'slack': { domain: 'slack.com', website: 'https://www.slack.com' },
  'fedex': { domain: 'fedex.com', website: 'https://www.fedex.com' },
  'fdx': { domain: 'fedex.com', website: 'https://www.fedex.com' },
  'ups': { domain: 'ups.com', website: 'https://www.ups.com' },
  // Shipping & other
  'disney+': { domain: 'disney.com', website: 'https://www.disney.com' },
  'dis': { domain: 'disney.com', website: 'https://www.disney.com' },
  'bp': { domain: 'bp.com', website: 'https://www.bp.com' },
  'lyft': { domain: 'lyft.com', website: 'https://www.lyft.com' },
  'uber': { domain: 'uber.com', website: 'https://www.uber.com' },
  'yum': { domain: 'yum.com', website: 'https://www.yum.com' },
  'low': { domain: 'lowes.com', website: 'https://www.lowes.com' },
  'dnkn': { domain: 'dunkindonuts.com', website: 'https://www.dunkindonuts.com' },
  'googl': { domain: 'google.com', website: 'https://www.google.com' },
  'msft': { domain: 'microsoft.com', website: 'https://www.microsoft.com' },
}
...
/** Backward-compatible case-insensitive proxy */
