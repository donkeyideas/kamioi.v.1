  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        >
          <img src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg" alt="Download on the App Store" height="40" style={{ display: 'block' }} />
        </a>
        <a
          ...
          onMouseLeave={e => { e.currentTarget.style.transform = 'scale(1)' }}
        >
          <img src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png" alt="Get it on Google Play" height="60" style={{ display: 'block', marginTop: '-10px', marginBottom: '-10px' }} />
        </a>
      </div>
    </div>
  )
