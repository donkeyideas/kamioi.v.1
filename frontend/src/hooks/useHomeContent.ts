...
const DEFAULTS: HomeContent = {
  ...
  feature_2_desc: 'Our AI analyzes your spending patterns and maps purchases to relevant stocks — optimizing your strategy in real-time.',
